...
export const NoEmailSelected = () => {
  const { setComposeOpen, setComposeMinimized, setComposeDraft } = useUIStore();
    ...
    <div className="flex flex-col items-center justify-center h-full text-muted-foreground">
      ...
      <div className="flex items-center justify-center space-y-2">
        <button
          ...
          className="flex items-center gap-2 px-3 py-1 border border-gray-500 bg-[#313131] text-gray-300 rounded-md text-sm cursor-pointer"
        >
